	...
	<a href="adoptanos">
		<article>
				...
				<div class="sliders_child_container slide-1">
					<img class="imagen_slider" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/pngwing-1.png'; ?>" alt="perro">
	...
	<article>
		<a href="contacto">
			<div class="sliders_child_container slide-2">
				<img class="imagen_slider" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/pngwing-2.png'; ?>" alt="perro">
				<div class="container_text_slider">
					<h2>contáctanos</h2>
	...
	<article>
		<a href="https://esponsor.com/callejerosbuscanhogar?fbclid=IwAR2eN9qOX95zuOZ7PVTKR9f9L86VySsm6CQv0Zheb_sp8e5TLPVuDzhE7G0" target="_blank">
			<div class="sliders_child_container slide-3">
				<img class="imagen_slider" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/Black-Dog-PNG-High-Quality-Image-1.png'; ?>" alt="perro">
				<div class="container_text_slider">
...
<section class="container_grid my-5">
  <a href="https://esponsor.com/callejerosbuscanhogar?fbclid=IwAR2eN9qOX95zuOZ7PVTKR9f9L86VySsm6CQv0Zheb_sp8e5TLPVuDzhE7G0" target="_blank" class="area_centro">
	...
	<img class="img_enlaces" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/pngwing-3.png'; ?>" alt=""></a>
  ...
  <a href="proximos-eventos" class="area_izquierda">
	...
	<img class="img_enlaces" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/Black-Dog-PNG-High-Quality-Image-1.png'; ?>" alt=""></a>
...
<section class="container d-flex flex-column justify-content-around align-items-center my-5 text-center">
	...
	<img class="my-3" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/callejeros-instagram-1.png'; ?>" alt="logo fcbh">
	<div class="container">
	<?php
		while ( have_posts() ) :
			the_post();
...
<section class="seccion_rrss container-fluid my-5">
    <a href="<?php echo the_field('url_de_facebook');?>" class="card_rrss_facebook">
		...
		<p class="fw-bold"><?php echo the_field('usuario_de_facebook');?></p>
		<h5>FACEBOOK</h5>
	...
	<a href="<?php echo the_field('url_de_tiktok');?>" class="card_rrss_tiktok">
		<div class="container_svg_rrss">
	    ...
	    <p class="fw-bold"><?php echo the_field('usuario_de_tiktok');?></p>
		<h5>TIKTOK</h5>
...
<section class="seccion_banner my-5">
	...
	<img class="w-100" src="<?php echo wp_upload_dir()['baseurl'] . '/2023/11/vitalcan-1.png'; ?>" alt="banner publicidad vitalcan">
	</a>
</section>
	</main><!-- #main -->
