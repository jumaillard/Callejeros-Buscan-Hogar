...
<article id="post-<?php the_ID(); ?>" <?php post_class('row'); ?>>
	<section class="row contenedor-ficha mb-5">
		<div class="col-12 col-md-6">
			<img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID)); ?>"
				alt="<?php the_field('nombre'); ?>" class="imagen-ficha ms-md-5 m-auto">
		</div>
	...
	<section class="container">
		...
		<form action="" class="row">
			...
			<div class=" col-12 col-md-6">
				<label for="cantidad-personas" class="form-label mb-1">¿Cuántas personas viven en el hogar?, ¿Qué edades tienen?</label>
				<textarea name="cantidad-personas" id="cantidad-personas" cols="30" rows="5" class="form-control mb-4"></textarea>
			</div>
			...
			<div class=" col-12 col-md-6">
				<label for="estado-mascotas" class="form-label mb-1">Si la respuesta fue si, ¿De qué edades?, ¿Estan esterilizadas y/o vacunadas?</label>
				<textarea name="estado-mascotas" id="estado-mascotas" cols="30" rows="5" class="form-control mb-4"></textarea>
			</div>
			...
			<div class=" col-12 col-md-6">
				<label for="esterilizacion" class="form-label mb-1">¿Está de acuerdo con la esterilización?, ¿Por qué?</label>
				<textarea name="esterilizacion" id="esterilizacion" cols="30" rows="5" class="form-control mb-4"></textarea>
			</div>
				
			<div class=" col-12 col-md-6">
				<label for="crecimiento" class="form-label mb-1">¿Qué pasaría si la mascota adotada crece más de lo que espera?</label>
				<textarea name="crecimiento" id="crecimiento" cols="30" rows="5" class="form-control mb-4"></textarea>
			</div>
				
			<div class=" col-12 col-md-6">
				<label for="cuidados" class="form-label mb-1">¿Quién cuidaría a la mascota si usted saliera de vacaciones?</label>
