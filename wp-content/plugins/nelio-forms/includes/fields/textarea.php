...
namespace Nelio_Forms\Fields\Textarea;
...
function sanitize( $field_submit ) {
	return sanitize_textarea_field( wp_unslash( $field_submit ) );
}//end sanitize()
add_filter( 'nelio_forms_sanitize_textarea_field', __NAMESPACE__ . '\sanitize', 5 );
...
add_filter( 'nelio_forms_validate_textarea_field', __NAMESPACE__ . '\validate', 5, 3 );
